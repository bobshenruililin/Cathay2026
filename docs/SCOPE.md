...
1. `packages/engine` — HKG MCT feasibility, ranking, recovery options, UM / wheelchair / party / downgrade, human-readable `reasoning`. Additive passenger fields: `um`, `wheelchair`, `ssr`, `partyId`, `partySize`.
