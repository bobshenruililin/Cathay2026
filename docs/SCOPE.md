...
1. `packages/engine` — HKG MCT feasibility, ranking, recovery options, UM / wheelchair / party / downgrade / SSR, human-readable `reasoning`. Gate-desk stories: `packages/engine/tests/scenarios/` (JSON 01–40).
